...
parser.add_argument('--input_2d', type=str,
                    default='data/d13_route_40001001011/oneformer/output/route_batch/input_2d_92600542024.pkl',
                    help='2d vertices')
parser.add_argument('--input_3d_proj', type=str,
                    default='data/d13_route_40001001011/oneformer/output/route_batch/lidar_project_info_926005420241.csv',
