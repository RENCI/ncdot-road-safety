...
To use our final models obtained through the iterative AL process directly or as pretrained models for transfer learning,  you can download them from this repo: [guardrail model](https://github.com/RENCI/ncdot-road-safety/blob/master/machine-learning/models/guardrail_round5.h5) and [utility pole model](https://github.com/RENCI/ncdot-road-safety/blob/master/machine-learning/models/pole_round4.h5). 
