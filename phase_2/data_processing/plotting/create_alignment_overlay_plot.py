...
parser.add_argument('--input_2d', type=str,
                    default='../data/d13_route_40001001012/test/input_2d_88100042414.csv',
                    help='2d vertices')
parser.add_argument('--input_3d_proj', type=str,
                    default='../data/d13_route_40001001012/test/lidar_project_info_88100042414.csv',
                    help='3d projection vertices')
parser.add_argument('--overlay_bg_image_path', type=str,
                    default='../data/d13_route_40001001012/images/881000424141.jpg',
