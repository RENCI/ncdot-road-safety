...
parser.add_argument('--division', type=str, default='d13', help='division str on the path')
...
parser.add_argument('--output_html_file', type=str, default='../server/templates/model_2lane_d13_subset.html',
...
sub_df = pd.concat([df_yes.sample(n=sample_size, random_state=1),
                    df_no.sample(n=sample_size, random_state=1)])
print(sub_df.shape)

create_html_file_for_inspection(sub_df, output_html_file, two_models=False)
