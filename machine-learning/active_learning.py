...
def get_train_val_generator(bat_size):
...
def get_model():
    ...
    feature_model.compile(optimizer=keras.optimizers.Adam(1e-5),  # Very low learning rate
...
if __name__ == '__main__':
    ...
    if not make_inference_only:
        ...
        train_generator, validation_generator = get_train_val_generator(batch_size)
