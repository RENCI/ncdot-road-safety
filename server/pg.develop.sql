...
4okjdsscisk7kwguxoegxsluxo8ucifs	.eJxVjDsOwjAQRO_iGllee7OxKek5g-XPggPIluKkQtydREoBzRTz3sxb-LAuxa-dZz9lcRZgxOm3jCE9ue4kP0K9N5laXeYpyl2RB-3y2jK_Lof7d1BCL9s62jyAs-oGiA5NJHCRLSkdgJRJI1qlgLfUA3MiQEdmBEyknEbiJD5fzR82Uw:1ldZjC:Oomjt70_dWW41XmwTi58n6hHC9gtznWvNxEhv_Jn4WI	2021-05-17 14:39:18.97112+00
\.
...
SELECT pg_catalog.setval('public.rs_core_aiimageannotation_id_seq', 12577422, true);
...
SELECT pg_catalog.setval('public.rs_core_userimageannotation_id_seq', 985, true);
...
SELECT pg_catalog.setval('public.rs_core_userprofile_id_seq', 13, true);
